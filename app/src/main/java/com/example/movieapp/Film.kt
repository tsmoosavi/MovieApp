...
object Film {
    var movie1 = Movie(R.drawable.fastfive,R.string.fast5)
    var movie2 = Movie(R.drawable.fastsix,R.string.fast6)
    var movie3 = Movie(R.drawable.fastseven,R.string.fast7)
    var movie4 = Movie(R.drawable.fasteight,R.string.fast8)
...
class Movie(var imageId:Int, var nameId: Int){
